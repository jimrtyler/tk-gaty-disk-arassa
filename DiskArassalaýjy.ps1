...
#GUI Variables
$FormTitleText = "Jim Taýleriň (PowerShellEngineer.com) tarapyndan disk arassalaýjy"
$SelectDiskLabelText = "Diski saýlaň:"
$FreeSpaceLabelText = "Boş ýer (gigabaýt):"
$TotalSpaceLabelText = "Jemi giňişlik (gigabaýt):"
$JunkFoundLabelText = "gereksiz zatlar tapyldy (gigabaýt):"
$CleanDiskBtnText = "Arassa diski * Faýllary pozuň *"
$SpaceCleanedLabelText = "Arassalanan ýer (gigabaýt):"
$LogFileLabelText = "fileurnal faýly tapyldy: $ abcdefg"
$CreditLabelText = "Jim Taýleriň ssenarisi - PowerShellEngineer.com"
$LogFileLocatedText = "fileurnal faýly tapyldy"
$AnalyzingDriveText = "Sürüjileri derňemek ..."
$BrowsersAreRunningText = "Brauzerler işleýär ... Ulanyja habar beriň ..."
$PleaseCloseBrowsersText = "webhli web brauzerlerini ýapyň we gaýtadan synanyşyň."
$CleaningDriveText = "Sürüjini arassalamak ..."
